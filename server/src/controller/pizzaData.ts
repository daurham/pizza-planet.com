...
export const postPizzaData = (req: Request, res: Response) => {
  ...
  postPizza(name, calories, popularity, price, instructions, notes, img, toppings, res);
};
...
export const updatePizzaData = (req: Request, res: Response) => {
  const { name, calories, popularity, price, instructions, notes, img, toppings } = req.body;
  updatePizza(name, calories, popularity, price, instructions, notes, img, toppings, res);
};
